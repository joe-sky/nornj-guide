...
* Getting Started
    * [Use JSX extension syntax](getting-started/use-it-in-jsx.md)
    * [Use tagged template expression](getting-started/use-tagged-templates.md)
* [JSX extension syntax](jsx-syntax/index.md)
...
* [Tagged template expression](tagged-templates-syntax/index.md)
